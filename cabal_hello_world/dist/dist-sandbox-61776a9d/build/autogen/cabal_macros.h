...
/* package cabal-hello-world-0.1.0.0 */
#define VERSION_cabal_hello_world "0.1.0.0"
#define MIN_VERSION_cabal_hello_world(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "cabal-hello-world-0.1.0.0"

#define CURRENT_PACKAGE_KEY "cabal-hello-world-0.1.0.0"
